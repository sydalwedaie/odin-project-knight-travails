...
I’m proud of this achievement, especially in this AI-driven age of coding. A few times in the past I would resort to AI to _help_ me solve a problem without giving me the solution, after struggling for a few hours or a day at most. For this one, I made it a goal to never touch it. An LLM would have most probably tried to _help_ me shoe-horn an adjacency list into the solution, even if it wasn’t a good tool for this project. The community, however, saw the bigger problem and helped accordingly. From there, I didn't have sudden flashes of ingenuity or anything; I just kept experimenting, moving ever so slightly closer to the solution until one last run when it finally worked.
